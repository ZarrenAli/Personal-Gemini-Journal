...
export const REALM_THEMES: Record<MonumentRealmTheme, RealmThemeTokens> = {
  rose: {
    ...
    sidebarBorder: 'border-rose-200/40',
    sidebarHover: 'hover:bg-rose-100/30 hover:text-rose-950',
    sidebarActive: 'bg-rose-500/80 text-white shadow-xs shadow-rose-500/30',
    ...
    inputBg: 'bg-white/10',
    inputBorder: 'border-rose-200/50',
    inputFocus: 'focus:outline-hidden focus:border-rose-400 focus:ring-2 focus:ring-rose-300/50',
    pillActive: 'bg-rose-100/40 text-rose-950 border-rose-400 ring-1 ring-rose-300/50 shadow-xs',
    pillInactive: 'bg-white/10 text-rose-900 border-rose-200/40 hover:bg-white/30 hover:border-rose-300',
    userBubble: 'bg-white/20 border border-rose-200/40 text-rose-950 shadow-xs',
    geminiBubble: 'bg-rose-50/20 border border-rose-200/40 text-rose-950 shadow-xs',
    modalHeaderBg: 'bg-rose-50/20 border-b border-rose-200/40 backdrop-blur-md',
    modalBodyBg: 'bg-white/10 backdrop-blur-xl',
  ...
  sand: {
    ...
    sidebarBg: 'bg-white/5 backdrop-blur-md',
    sidebarBorder: 'border-amber-200/40',
    sidebarHover: 'hover:bg-amber-100/30 hover:text-amber-950',
    sidebarActive: 'bg-amber-600/80 text-white shadow-xs shadow-amber-600/30',
    sidebarActiveText: 'text-white',
    sidebarInactiveText: 'text-stone-600',
    cardBg: 'bg-white/10 backdrop-blur-md',
    ...
    pillActive: 'bg-amber-100/40 text-amber-950 border-amber-500 ring-1 ring-amber-300/50 shadow-xs',
    pillInactive: 'bg-white/10 text-amber-950 border-amber-200/40 hover:bg-white/30 hover:border-amber-300',
    userBubble: 'bg-white/20 border border-amber-200/40 text-amber-950 shadow-xs',
    geminiBubble: 'bg-amber-50/20 border border-amber-200/40 text-amber-950 shadow-xs',
    modalHeaderBg: 'bg-amber-50/20 border-b border-amber-200/40 backdrop-blur-md',
    modalBodyBg: 'bg-white/10 backdrop-blur-xl',
  ...
  teal: {
    ...
    sidebarBg: 'bg-white/5 backdrop-blur-md',
    sidebarBorder: 'border-teal-200/40',
    sidebarHover: 'hover:bg-teal-100/30 hover:text-teal-950',
    sidebarActive: 'bg-teal-600/80 text-white shadow-xs shadow-teal-600/30',
    sidebarActiveText: 'text-white',
    sidebarInactiveText: 'text-stone-600',
    cardBg: 'bg-white/10 backdrop-blur-md',
    ...
    inputBg: 'bg-white/10',
    inputBorder: 'border-teal-200/50',
    inputFocus: 'focus:outline-hidden focus:border-teal-500 focus:ring-2 focus:ring-teal-300/50',
    pillActive: 'bg-teal-100/40 text-teal-950 border-teal-500 ring-1 ring-teal-300/50 shadow-xs',
    pillInactive: 'bg-white/10 text-teal-950 border-teal-200/40 hover:bg-white/30 hover:border-teal-300',
    userBubble: 'bg-white/20 border border-teal-200/40 text-teal-950 shadow-xs',
    geminiBubble: 'bg-teal-50/20 border border-teal-200/40 text-teal-950 shadow-xs',
    modalHeaderBg: 'bg-teal-50/20 border-b border-teal-200/40 backdrop-blur-md',
    modalBodyBg: 'bg-white/10 backdrop-blur-xl',
  ...
  twilight: {
    ...
    sidebarBg: 'bg-white/5 backdrop-blur-md',
    sidebarBorder: 'border-indigo-200/40',
    sidebarHover: 'hover:bg-indigo-100/30 hover:text-indigo-950',
    sidebarActive: 'bg-indigo-600/80 text-white shadow-xs shadow-indigo-600/30',
    sidebarActiveText: 'text-white',
    sidebarInactiveText: 'text-stone-600',
    cardBg: 'bg-white/10 backdrop-blur-md',
    cardBorder: 'border-white/10',
    cardBorderHover: 'hover:border-white/30 hover:bg-white/20',
    cardActiveBorder: 'border-indigo-300/50',
    cardActiveRing: 'ring-1 ring-indigo-300/50 shadow-md shadow-indigo-900/5',
    cardShadow: 'shadow-xs',
    ...
    primaryBtn:
      'bg-gradient-to-r from-indigo-500 to-violet-500 hover:from-indigo-400 hover:to-violet-400 text-white shadow-xs shadow-indigo-500/20 border border-white/30',
    secondaryBtn:
      'bg-white/10 hover:bg-white/20 text-white border border-white/20 shadow-2xs',
    iconBtnHover: 'hover:bg-white/10 hover:text-white',
    accentBadge: 'bg-indigo-900/50 text-indigo-200 border border-indigo-700/50',
    accentDot: 'bg-indigo-400',
    accentIconBg: 'bg-indigo-900/50',
    accentIconBorder: 'border-indigo-700/50',
    accentIconColor: 'text-indigo-300',
    inputBg: 'bg-white/10',
    inputBorder: 'border-white/20',
    inputFocus: 'focus:outline-hidden focus:border-indigo-300 focus:ring-2 focus:ring-indigo-300/50 text-white',
    pillActive: 'bg-indigo-500/40 text-white border-indigo-400 ring-1 ring-indigo-300/50 shadow-xs',
    pillInactive: 'bg-white/5 text-indigo-100 border-white/20 hover:bg-white/10 hover:border-white/40',
    userBubble: 'bg-white/10 border border-white/20 text-white shadow-xs',
    geminiBubble: 'bg-indigo-900/30 border border-indigo-700/30 text-white shadow-xs',
    modalHeaderBg: 'bg-indigo-900/30 border-b border-white/10 backdrop-blur-md',
    modalBodyBg: 'bg-white/10 backdrop-blur-xl',
